 ...
 * @author David Fraska */
public interface TileMapRenderer extends MapRender {
...
//		render(main, 0, 0, (int)getMapWidthUnits(), (int)(getMapHeightUnits()));
//	}
//
...
//	public void render (WitchCraft main, float x, float y, float width, float height) {
//		render(main, x, y, width, height, allLayers);
//	}
//
//	/** Renders specific layers in the given a camera
//	 * @param cam The camera to use */
//	public void render (WitchCraft main, OrthographicCamera cam) {
//		render(main, cam, allLayers);
//	}
//
...
//	 *           number is too high. */
//	public void render (WitchCraft main, OrthographicCamera cam, int[] layers) {
//		getProjectionMatrix().set(cam.combined);
//		tmp.set(0, 0, 0);
//		cam.unproject(tmp);
//		render(main, tmp.x, tmp.y, cam.viewportWidth * cam.zoom, cam.viewportHeight * cam.zoom, layers);
//	}
//
...
//	 * @param layers The list of layers to draw, 0 being the lowest layer. You will get an IndexOutOfBoundsException if a layer
//	 *           number is too high. */
//	public void render (WitchCraft main, float x, float y, float width, float height, int[] layers) {
