...
public class PolygonSpriteWrap {
	
	PolygonRegionWrap region;
	private float x, y;
	...
	public PolygonSpriteWrap (PolygonRegionWrap region) {
		setRegion(region);
		setColor(1, 1, 1, 1);
	...
	public PolygonSpriteWrap (PolygonSpriteWrap sprite) {
		set(sprite);
	}

	public void set (PolygonSpriteWrap sprite) {
	...
	public void translateX (float xAmount) {
		...
		for(int i=0; i<vertices.length; i+=Util.VERTEX_SIZE){
			vertices[i] += xAmount;
		}
	}
	...
	public void draw (PolygonSpriteBatchWrap spriteBatch) {
		spriteBatch.draw(region, getVertices(), 0, vertices.length);
	}

	public void draw (PolygonSpriteBatchWrap spriteBatch, float alphaModulation) {
	...
	public void setRegion (PolygonRegionWrap region) {
		this.region = region;
