...
public class OrthoTileRenderer extends BatchTileRenderer {
	private float[] vertices = new float[20];

	public OrthoTileRenderer(TiledMap map) {
		super(map);
	}

	public OrthoTileRenderer(TiledMap map, Batch batch) {
		super(map, batch);
	}

	public OrthoTileRenderer(TiledMap map, float unitScale) {
		super(map, unitScale);
	}

	public OrthoTileRenderer(TiledMap map, float unitScale, Batch batch) {
