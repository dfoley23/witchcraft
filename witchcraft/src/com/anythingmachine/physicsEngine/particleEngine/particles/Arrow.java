...
public class Arrow extends Particle {
	...
	if (!WitchCraft.cam.inBigBounds(pos)) {
		...
		collisionBody
			.setTransform((pos.x + sprite.getWidth() * 0.5f)
				* Util.PIXEL_TO_BOX,
				(pos.y + sprite.getHeight() * 0.5f)
					* Util.PIXEL_TO_BOX,
	...
	if (other.type == EntityType.PLATFORM || other.type == EntityType.WALL
		|| other.type == EntityType.STAIRS) {
	    stop();
