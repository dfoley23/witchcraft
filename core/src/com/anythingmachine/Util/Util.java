package com.anythingmachine.Util;
...
//	}
	...
	public static final int FIRESPEED = 87;
	public static final float BASEGROUNDY = 112.0f;
	public static final float PLAYERWALKSPEED = 120f;
	...
	public static final short CATEGORY_NPCMASK = 0x0002;
	public static final short CATEGORY_NPC = 0x0004;
	public static final short CATEGORY_ITEMS = 0x0008;
	public static final short CATEGORY_PARTICLES= 0x0010;
	public static final short CATEGORY_TRIGGERS = 0x0020;
	public static final short CATEGORY_WALLS = 0x0040;
	public static final short CATEGORY_STAIRS = 0x0080;
	public static final short CATEGORY_PLATFORMS = 0x0100;
	public static final short CATEGORY_FEET = 0x0200;
	public static final short CATEGORY_IGNORE = 0x0400;
	...
	public enum EntityType {
		PLATFORM, STAIRS, STAIRUPTRIGGER, STAIRDOWNTRIGGER, DOOR, ENTITY, MOUSEINPUT, SWORD, ARROW, PLAYER, FIRE, PARTICLE,NONPLAYER, WALL,LEVELWALL,ACTIONWALL,AINODE,INVENTORYOBJECT
	}
