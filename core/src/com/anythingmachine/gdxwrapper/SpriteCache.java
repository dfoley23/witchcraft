 ...
 * blending (<i>Gdx.gl.glEnable(GL20.GL_BLEND);</i>) and set the blend func as
...
public class SpriteCache implements Disposable {
	...
	/**
	 * Creates a cache that uses indexed geometry and can contain up to 1000
	 * images.
	 */
	public SpriteCache() {
		this(1000, false);
	...
	/**
	 * Creates a cache with the specified size, using a default shader if OpenGL
	 * ES 2.0 is being used.
	 * 
	 * @param size
	 ...
	 * SpriteCache. Default is {@link Color#WHITE}.
	 */
	public void setColor(Color tint) {
		color = tint.toFloatBits();
		int size = mesh.getNumVertices() * 5;
	 ...
	 * called called "a_texCoords", the color attribute is called "a_color". The
	 * projection matrix is uploaded via a mat4 uniform called "u_proj", the
	 * transform matrix is uploaded via a uniform called "u_trans", the combined
