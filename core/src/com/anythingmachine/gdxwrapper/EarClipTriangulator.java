...
public final class EarClipTriangulator {
	...
	private int classifyVertex(int index) {
		final Vector2 previousVertex = vertices
				.get(computePreviousIndex(index));
	...
	private static int computeSpannedAreaSign(final Vector2 p1,
	...
	private void cutEarTip(final int pEarTipIndex) {
		...
		System.arraycopy(vertexTypes, pEarTipIndex + 1, vertexTypes,
				pEarTipIndex, vertexCount - pEarTipIndex - 1);
		vertexCount--;
	}
